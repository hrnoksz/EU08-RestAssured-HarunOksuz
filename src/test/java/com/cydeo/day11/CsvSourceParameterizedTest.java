...
//            10, 9 , 19
    ...
    @ParameterizedTest //This comes from Junit Library
    @CsvSource({"1, 3 , 4", //Csv stands for Comma Separate Values
                "2, 3 , 5",
                "8, 7 , 15",
                "10, 9 , 19"})
    public void testAddition(int num1, int num2, int sum) {
        ...
        //assert num1+ num2 equalTo sum
        assertThat(num1 + num2, equalTo(sum)); //HamCrest assertion is coming from RestAssured Library
    }
    ...
    public void zipCodeMultiInputTest(String state,String city){
        ...
        int placeNumber = given()
                ...
                //We use single quote for 'place name', because there is space between place
                // and name!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                //.log().body()
                .extract()
